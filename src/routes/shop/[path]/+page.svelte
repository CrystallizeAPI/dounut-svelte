    ...
    <div class="left-0 right-0 rounded-full  top-[20%]"></div>
      ...
      <div class="py-5">
        <div class="flex lg:flex-row flex-col items-center mt-10 mb-5">
          ...
          <img width="400px" class="w-2/3 rounded-sm" alt={product.defaultVariant.firstImage.altText} src={product.defaultVariant.firstImage.url} />
        </div>
      ...
      <div class="bg-background5 absolute aspect-square rounded-full w-[100vw]  -translate-y-10  -translate-x-1/4 -z-10">
        </div>
      <div>
